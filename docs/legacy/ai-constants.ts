/**
 * LEGACY AI Constants - Moved from src/shared/constants/ai.ts
 *
 * These constants are not currently used in the application but may be
 * needed for future embedding/RAG functionality. They are preserved here
 * for reference and can be moved back when needed.
 */
