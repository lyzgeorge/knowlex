...
### 1. 主界面：新建聊天 / 未归类聊天 (Home / New Chat / Uncategorized Chat)



这是应用启动或点击“+ New Chat”时显示的初始界面。左侧为固定宽度导航栏，右侧为主内容区。
...
### 2. 全局搜索模态框 (Global Search Modal)



点击左侧边栏的“全局搜索”图标时弹出的居中模态框。
...
### 3. 新建项目模态框 (New Project Modal)



点击左侧边栏“Projects”旁边的“+”按钮时弹出的模态框。
...
### 5. 项目聊天页 (Project Chat Page)



点击项目下的某个会话时显示此页面。包含 RAG 引用和“存为知识”悬浮按钮提示。
...
### 6. 项目文件管理页 (Project File Management Page)



点击项目列表中的文件管理图标或项目概览页的“项目文件”按钮时显示。
...
### 7. 文件预览/编辑模态框 (File Preview/Edit Modal)



此模态框现在明确显示左侧的“内容”和“元数据”标签页，以及右侧的 PDF/A 预览。
...
### 8. 项目记忆与知识页 (Project Memory & Knowledge Page)
...
### 9. 知识 Markdown 编辑器模态框 (Knowledge Markdown Editor Modal)
